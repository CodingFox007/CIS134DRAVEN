...
<head>
	...
	<!-- This page is an example php application to show array processing. -->
	<title>Arrays</title>
</head>
<body>
	<h1>Using Arrays</h1>
	...
	<p>Normal arrays use numeric indexes starting at zero to identify each member of the array. Arrays in PHP can contain different data types but normal arrays usually have all members of the same data type. Indexes usually go in order by 1, but PHP does allow you to skip indexes. You will need to look at the actual code to see how arrays work, but below is the output of the array examples.
	</p>
	<?php //Creating array using array function.
		...
		$Colors[10] = "cyan";
		echo "Adding at the end color crimson.<br />";
		$Colors[] = "crimson";		
