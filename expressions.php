...
<body>
	...
	<p>Postfix ++ operator increments after other operations are done on a PHP statement. Prefix ++ operator increments before other operations are done on a PHP statement.
		</p>
	...
	<h3>Examples of Comparison</h3>
		<p> Two equal signs compares to see if the values are equal. Three equal signs compares to see if values are equal and if the data types are equal.
		</p>
