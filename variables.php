...
<body>
	...
	<ol>
		...
		<li>PHP does not specify a variable type on a variable declaration like other languages.</li>
		<li>PHP variable names begin with $. The next symbol after the $ should be a letter. </li>
		<li>The symbol after the $ can be an underscore, but PHP has several reserved words that begin with the underscore so it is better to not use it for programmer defined variables.</li>
