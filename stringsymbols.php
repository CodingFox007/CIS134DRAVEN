...
<body>
	...
	<?php //Either single or double quotes are used around strings.
		echo "Example 1 uses single and double quotes for string literals and  uses \ to escape the quotes inside the literals.<br/>";
		$name = 'Jane Doe';
		...
		$quantityofhats = "3 hats";
			echo "$quantityofhats + 2 equals " .($quantityofhats + 2)."<br />";
	?>
	</p>
</body>
</html>